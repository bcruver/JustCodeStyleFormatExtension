namespace JustCodeStyleFormatExtension.Langugage.Csharp.Warning.Spacing.SA1000
{
    ...
    public class KeyWordSpacingSwitch : CodeMarkerProviderModuleBase
    {
        ...
        private const string WarningId = "SA1000A-CSharp-Switch";
        private const string MarkerText = "CSharp - Spacing around keyword \"Switch\" should be spaced correctly";
        private const string Description = "CSharp - Spacing around keyword \"Switch\" should be spaced correctly";
        private const string FixText = "CSharp - Spacing around keyword \"Switch\" should be spaced correctly";
