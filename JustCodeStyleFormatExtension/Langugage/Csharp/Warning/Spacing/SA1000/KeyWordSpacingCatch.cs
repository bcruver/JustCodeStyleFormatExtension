namespace JustCodeStyleFormatExtension.Langugage.Csharp.Warning.Spacing.SA1000
{
    ...
    public class KeyWordSpacingCatch : CodeMarkerProviderModuleBase
    {
        ...
        private const string WarningId = "SA1000A-CSharp-Catch";
        private const string MarkerText = "CSharp - Spacing around keyword \"Catch\" should be spaced correctly";
        private const string Description = "CSharp - Spacing around keyword \"Catch\" should be spaced correctly";
        private const string FixText = "CSharp - Spacing around keyword \"Catch\" should be spaced correctly";
