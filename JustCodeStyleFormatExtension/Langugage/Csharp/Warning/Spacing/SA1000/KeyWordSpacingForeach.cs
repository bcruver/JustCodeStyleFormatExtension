namespace JustCodeStyleFormatExtension.Langugage.Csharp.Warning.Spacing.SA1000
{
    ...
    public class KeyWordSpacingForeach : CodeMarkerProviderModuleBase
    {
        ...
        private const string WarningId = "SA1000A-CSharp-Foreach";
        private const string MarkerText = "CSharp - Spacing around keyword \"Foreach\" should be spaced correctly";
        private const string Description = "CSharp - Spacing around keyword \"Foreach\" should be spaced correctly";
        private const string FixText = "CSharp - Spacing around keyword \"Foreach\" should be spaced correctly";
