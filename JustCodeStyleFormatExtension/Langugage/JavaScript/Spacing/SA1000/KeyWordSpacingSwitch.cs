namespace JustCodeStyleFormatExtension.Langugage.JavaScript.Spacing.SA1000
{
    ...
    public class KeyWordSpacingSwitch : CodeMarkerProviderModuleBase
    {
        ...
        private const string Description = "JavaScript - Spacing around keyword \"Switch\" should be spaced correctly";
        private const string FixText = "JavaScript - Spacing around keyword \"Switch\" should be spaced correctly";
