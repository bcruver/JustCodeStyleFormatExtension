namespace JustCodeStyleFormatExtension.Langugage.JavaScript.Spacing.SA1000
{
    ...
    public class KeyWordSpacingFor : CodeMarkerProviderModuleBase
    {
        ...
        private const string WarningId = "SA1000A-JavaScript-For";
        private const string MarkerText = "JavaScript - Spacing around keyword \"For\" should be spaced correctly";
        private const string Description = "JavaScript - Spacing around keyword \"For\" should be spaced correctly";
        private const string FixText = "JavaScript - Spacing around keyword \"For\" should be spaced correctly";
